package com.scrimfinderwq.scrimFinderWQ.models.web.google.service;

import com.scrimfinderwq.scrimFinderWQ.models.google.OauthResponse;
...
public class OauthTokenService {
    ...
    public String fetchToken(String code, String scope) {
        ...
        requestBody.add("redirect_uri", "http://localhost:8081/oauth2/callback/google");
